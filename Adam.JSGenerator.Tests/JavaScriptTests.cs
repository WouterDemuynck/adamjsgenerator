...
namespace Adam.JSGenerator.Tests
{
	...
	public class JavaScriptTests
	{
		...
		[TestMethod]
		public void ThisReturnsThis()
		{
			var t = JS.This();

			Assert.AreEqual("this;", t.ToString());
		}
		...
		[TestMethod]
		public void ExpressionReturnsSnippetExpression()
		{
			var s = JS.Expression("Yay!");

			Assert.AreEqual("Yay!;", s.ToString());
		}

		[TestMethod]
		public void StatementReturnsSnippetStatement()
		{
			var s = JS.Statement("Yay!");
